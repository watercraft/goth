...
See https://github.com/watercraft/goth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/watercraft/goth/examples/main.go to see this in action.
*/
